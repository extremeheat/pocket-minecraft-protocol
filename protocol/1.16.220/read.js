  ...
  const ctx = {
    ...
    ItemExtraDataWithBlockingTick: (buffer, offset) => {
      ...
      let { value: can_place_on, size: can_place_onSize } = ((buffer, offset) => {
        ...
        let size = countSize
        for (let i = 0; i < count; i++) {
          const elem = (ctx.ShortArray)(buffer, offset + size)
          data.push(elem.value)
          size += elem.size
        }
        return { value: data, size }
    ...
    Skin: (buffer, offset) => {
      ...
      let { value: animation_data, size: animation_dataSize } = (ctx.string)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize)
      let { value: premium, size: premiumSize } = (ctx.bool)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize)
      let { value: persona, size: personaSize } = (ctx.bool)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize)
      let { value: cape_on_classic, size: cape_on_classicSize } = (ctx.bool)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize)
      let { value: cape_id, size: cape_idSize } = (ctx.string)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize)
      let { value: full_skin_id, size: full_skin_idSize } = (ctx.string)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize + cape_idSize)
      let { value: arm_size, size: arm_sizeSize } = (ctx.string)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize + cape_idSize + full_skin_idSize)
      let { value: skin_color, size: skin_colorSize } = (ctx.string)(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize + cape_idSize + full_skin_idSize + arm_sizeSize)
      let { value: personal_pieces, size: personal_piecesSize } = ((buffer, offset) => {
        ...
        return { value: data, size }
      })(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize + cape_idSize + full_skin_idSize + arm_sizeSize + skin_colorSize)
      let { value: piece_tint_colors, size: piece_tint_colorsSize } = ((buffer, offset) => {
        ...
        return { value: data, size }
      })(buffer, offset + skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize + cape_idSize + full_skin_idSize + arm_sizeSize + skin_colorSize + personal_piecesSize)
      return { value: { skin_id, play_fab_id, skin_resource_pack, skin_data, animations, cape_data, geometry_data, animation_data, premium, persona, cape_on_classic, cape_id, full_skin_id, arm_size, skin_color, personal_pieces, piece_tint_colors }, size: skin_idSize + play_fab_idSize + skin_resource_packSize + skin_dataSize + animationsSize + cape_dataSize + geometry_dataSize + animation_dataSize + premiumSize + personaSize + cape_on_classicSize + cape_idSize + full_skin_idSize + arm_sizeSize + skin_colorSize + personal_piecesSize + piece_tint_colorsSize}
    },
      ...
      let { value: actions, size: actionsSize } = ((buffer, offset) => {
        ...
        for (let i = 0; i < count; i++) {
          ...
          let { value: type_id, size: type_idSize } = ((buffer, offset) => {
            const { value, size } = (ctx.u8)(buffer, offset)
            return { value: {"0":"take","1":"place","2":"swap","3":"drop","4":"destroy","5":"consume","6":"create","7":"lab_table_combine","8":"beacon_payment","9":"mine_block","10":"craft_recipe","11":"craft_recipe_auto","12":"craft_creative","13":"optional","14":"non_implemented","15":"results_deprecated"}[value] || value, size }
          })(buffer, offset)
          ...
          })(buffer, offset + type_idSize + count1Size + sourceSize + destinationSize + randomlySize + result_slot_idSize + primary_effectSize + secondary_effectSize + unknown1Size + predicted_durabilitySize + network_id1Size + recipe_network_idSize + item_idSize + filtered_string_indexSize + result_itemsSize)
          return { value: { type_id, count: count1, source, destination, randomly, result_slot_id, primary_effect, secondary_effect, unknown1, predicted_durability, network_id: network_id1, recipe_network_id, item_id, filtered_string_index, result_items, times_crafted }, size: type_idSize + count1Size + sourceSize + destinationSize + randomlySize + result_slot_idSize + primary_effectSize + secondary_effectSize + unknown1Size + predicted_durabilitySize + network_id1Size + recipe_network_idSize + item_idSize + filtered_string_indexSize + result_itemsSize + times_craftedSize}
        })(buffer, offset + size)
          data.push(elem.value)
          size += elem.size
        }
    ...
    ItemStackResponses: (buffer, offset) => {
      ...
      for (let i = 0; i < count; i++) {
        ...
        let { value: request_id1, size: request_id1Size } = (ctx.varint32)(buffer, offset + statusSize)
              ...
              for (let i = 0; i < count; i++) {
                ...
                let { value: slots, size: slotsSize } = ((buffer, offset) => {
                  ...
                  for (let i = 0; i < count; i++) {
                    ...
                    let { value: item_stack_id, size: item_stack_idSize } = (ctx.varint32)(buffer, offset + slot1Size + hotbar_slot1Size + count1Size)
    ...
    CommandOrigin: (buffer, offset) => {
      let { value: type, size: typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.varint)(buffer, offset)
        return { value: {"0":"player","1":"block","2":"minecart_block","3":"dev_console","4":"test","5":"automation_player","6":"client_automation","7":"dedicated_server","8":"entity","9":"virtual","10":"game_argument","11":"entity_server","12":"precompiled","13":"game_director_entity_server","14":"script"}[value] || value, size }
      })(buffer, offset)
    ...
    StructureBlockSettings: (buffer, offset) => {
      ...
      let { value: size1, size: size1Size } = (ctx.BlockCoordinates)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize)
      let { value: structure_offset, size: structure_offsetSize } = (ctx.BlockCoordinates)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size)
      let { value: last_editing_player_unique_id, size: last_editing_player_unique_idSize } = (ctx.zigzag64)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize)
      let { value: rotation, size: rotationSize } = (ctx.u8)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize)
      let { value: mirror, size: mirrorSize } = (ctx.u8)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize)
      let { value: integrity, size: integritySize } = (ctx.lf32)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize)
      let { value: seed, size: seedSize } = (ctx.lu32)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + integritySize)
      let { value: pivot, size: pivotSize } = (ctx.vec3f)(buffer, offset + palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + integritySize + seedSize)
      return { value: { palette_name, ignore_entities, ignore_blocks, size: size1, structure_offset, last_editing_player_unique_id, rotation, mirror, integrity, seed, pivot }, size: palette_nameSize + ignore_entitiesSize + ignore_blocksSize + size1Size + structure_offsetSize + last_editing_player_unique_idSize + rotationSize + mirrorSize + integritySize + seedSize + pivotSize}
    },
    ...
    packet_start_game: (buffer, offset) => {
      ...
      let { value: seed, size: seedSize } = (ctx.zigzag32)(buffer, offset + entity_idSize + runtime_entity_idSize + player_gamemodeSize + player_positionSize + rotationSize)
      ...
      let { value: dimension, size: dimensionSize } = (ctx.zigzag32)(buffer, offset + entity_idSize + runtime_entity_idSize + player_gamemodeSize + player_positionSize + rotationSize + seedSize + biome_typeSize + biome_nameSize)
      ...
      return { value: { entity_id, runtime_entity_id, player_gamemode, player_position, rotation, seed, biome_type, biome_name, dimension, generator, world_gamemode, difficulty, spawn_position, achievements_disabled, day_cycle_stop_time, edu_offer, edu_features_enabled, edu_product_uuid, rain_level, lightning_level, has_confirmed_platform_locked_content, is_multiplayer, broadcast_to_lan, xbox_live_broadcast_mode, platform_broadcast_mode, enable_commands, is_texturepacks_required, gamerules, experiments, experiments_previously_used, bonus_chest, map_enabled, permission_level, server_chunk_tick_range, has_locked_behavior_pack, has_locked_resource_pack, is_from_locked_world_template, msa_gamertags_only, is_from_world_template, is_world_template_option_locked, only_spawn_v1_villagers, game_version, limited_world_width, limited_world_length, is_new_nether, experimental_gameplay_override, level_id, world_name, premium_world_template_id, is_trial, movement_authority, rewind_history_size, server_authoritative_block_breaking, current_tick, enchantment_seed, block_properties, itemstates, multiplayer_correlation_id, server_authoritative_inventory }, size: entity_idSize + runtime_entity_idSize + player_gamemodeSize + player_positionSize + rotationSize + seedSize + biome_typeSize + biome_nameSize + dimensionSize + generatorSize + world_gamemodeSize + difficultySize + spawn_positionSize + achievements_disabledSize + day_cycle_stop_timeSize + edu_offerSize + edu_features_enabledSize + edu_product_uuidSize + rain_levelSize + lightning_levelSize + has_confirmed_platform_locked_contentSize + is_multiplayerSize + broadcast_to_lanSize + xbox_live_broadcast_modeSize + platform_broadcast_modeSize + enable_commandsSize + is_texturepacks_requiredSize + gamerulesSize + experimentsSize + experiments_previously_usedSize + bonus_chestSize + map_enabledSize + permission_levelSize + server_chunk_tick_rangeSize + has_locked_behavior_packSize + has_locked_resource_packSize + is_from_locked_world_templateSize + msa_gamertags_onlySize + is_from_world_templateSize + is_world_template_option_lockedSize + only_spawn_v1_villagersSize + game_versionSize + limited_world_widthSize + limited_world_lengthSize + is_new_netherSize + experimental_gameplay_overrideSize + level_idSize + world_nameSize + premium_world_template_idSize + is_trialSize + movement_authoritySize + rewind_history_sizeSize + server_authoritative_block_breakingSize + current_tickSize + enchantment_seedSize + block_propertiesSize + itemstatesSize + multiplayer_correlation_idSize + server_authoritative_inventorySize}
    },
    packet_add_player: (buffer, offset) => {
      ...
      let { value: runtime_entity_id, size: runtime_entity_idSize } = (ctx.varint64)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize)
      ...
      let { value: position, size: positionSize } = (ctx.vec3f)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize)
      let { value: velocity, size: velocitySize } = (ctx.vec3f)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize)
      let { value: pitch, size: pitchSize } = (ctx.lf32)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize)
      let { value: yaw, size: yawSize } = (ctx.lf32)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize)
      let { value: head_yaw, size: head_yawSize } = (ctx.lf32)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize)
      let { value: held_item, size: held_itemSize } = (ctx.Item)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize)
      let { value: metadata, size: metadataSize } = (ctx.MetadataDictionary)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + held_itemSize)
      let { value: flags, size: flagsSize } = (ctx.varint)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + held_itemSize + metadataSize)
      let { value: command_permission, size: command_permissionSize } = (ctx.varint)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + held_itemSize + metadataSize + flagsSize)
      let { value: action_permissions, size: action_permissionsSize } = (ctx.varint)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + held_itemSize + metadataSize + flagsSize + command_permissionSize)
      let { value: permission_level, size: permission_levelSize } = (ctx.varint)(buffer, offset + uuidSize + usernameSize + entity_id_selfSize + runtime_entity_idSize + platform_chat_idSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + held_itemSize + metadataSize + flagsSize + command_permissionSize + action_permissionsSize)
    ...
    packet_add_entity: (buffer, offset) => {
      ...
      let { value: position, size: positionSize } = (ctx.vec3f)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize)
      let { value: velocity, size: velocitySize } = (ctx.vec3f)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize)
      let { value: pitch, size: pitchSize } = (ctx.lf32)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize)
      let { value: yaw, size: yawSize } = (ctx.lf32)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize + pitchSize)
      let { value: head_yaw, size: head_yawSize } = (ctx.lf32)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize + pitchSize + yawSize)
      let { value: attributes, size: attributesSize } = (ctx.EntityAttributes)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize)
      let { value: metadata, size: metadataSize } = (ctx.MetadataDictionary)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + attributesSize)
      let { value: links, size: linksSize } = (ctx.Links)(buffer, offset + entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + attributesSize + metadataSize)
      return { value: { entity_id_self, runtime_entity_id, entity_type, position, velocity, pitch, yaw, head_yaw, attributes, metadata, links }, size: entity_id_selfSize + runtime_entity_idSize + entity_typeSize + positionSize + velocitySize + pitchSize + yawSize + head_yawSize + attributesSize + metadataSize + linksSize}
    },
    ...
    packet_animate: (buffer, offset) => {
      let { value: action_id, size: action_idSize } = ((buffer, offset) => {
        const { value, size } = (ctx.zigzag32)(buffer, offset)
        return { value: {"0":"none","1":"swing_arm","2":"unknown","3":"wake_up","4":"critical_hit","5":"magic_critical_hit","6":"row_right","7":"row_left"}[value] || value, size }
      })(buffer, offset)
    ...
    packet_event: (buffer, offset) => {
      ...
      let { value: event_type, size: event_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.zigzag32)(buffer, offset)
        return { value: {"0":"achievement_awarded","1":"entity_interact","2":"portal_built","3":"portal_used","4":"mob_killed","5":"cauldron_used","6":"player_death","7":"boss_killed","8":"agent_command","9":"agent_created","10":"banner_pattern_removed","11":"commaned_executed","12":"fish_bucketed","13":"mob_born","14":"pet_died","15":"cauldron_block_used","16":"composter_block_used","17":"bell_block_used","18":"actor_definition","19":"raid_update","20":"player_movement_anomaly","21":"player_moement_corrected","22":"honey_harvested","23":"target_block_hit","24":"piglin_barter"}[value] || value, size }
    ...
    packet_clientbound_map_item_data: (buffer, offset) => {
      ...
      })(buffer, offset + map_idSize + update_flagsSize + dimensionSize + lockedSize)
      ...
      })(buffer, offset + map_idSize + update_flagsSize + dimensionSize + lockedSize + included_inSize)
      ...
      })(buffer, offset + map_idSize + update_flagsSize + dimensionSize + lockedSize + included_inSize + scaleSize)
      ...
      })(buffer, offset + map_idSize + update_flagsSize + dimensionSize + lockedSize + included_inSize + scaleSize + trackedSize)
      return { value: { map_id, update_flags, dimension, locked, included_in, scale, tracked, texture }, size: map_idSize + update_flagsSize + dimensionSize + lockedSize + included_inSize + scaleSize + trackedSize + textureSize}
    },
            ...
            for (let i = 0; i < count; i++) {
              ...
              for (let i = 0; i < count; i++) {
                ...
                let { value: value_type, size: value_typeSize } = ((buffer, offset) => {
                  const { value, size } = (ctx.lu16)(buffer, offset)
                  return { value: {"1":"int","2":"float","3":"value","4":"wildcard_int","5":"operator","6":"target","16":"file_path","32":"string","40":"position","44":"message","46":"raw_text","50":"json","63":"command"}[value] || value, size }
    ...
    packet_structure_block_update: (buffer, offset) => {
      ...
      return { value: { position, structure_name, data_field, include_players, show_bounding_box, structure_block_type, settings, redstone_save_mode, should_trigger }, size: positionSize + structure_nameSize + data_fieldSize + include_playersSize + show_bounding_boxSize + structure_block_typeSize + settingsSize + redstone_save_modeSize + should_triggerSize}
    },
    ...
    packet_npc_request: (buffer, offset) => {
      ...
      let { value: request_type, size: request_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"0":"set_actions","1":"execute_action","2":"execute_closing_commands","3":"set_name","4":"set_skin","5":"set_interaction_text"}[value] || value, size }
      })(buffer, offset + runtime_entity_idSize)
      let { value: command, size: commandSize } = (ctx.string)(buffer, offset + runtime_entity_idSize + request_typeSize)
      let { value: action_type, size: action_typeSize } = (ctx.u8)(buffer, offset + runtime_entity_idSize + request_typeSize + commandSize)
      return { value: { runtime_entity_id, request_type, command, action_type }, size: runtime_entity_idSize + request_typeSize + commandSize + action_typeSize}
    },
    packet_photo_transfer: (buffer, offset) => {
      ...
      return { value: { image_name, image_data, book_id }, size: image_nameSize + image_dataSize + book_idSize}
    },
    ...
    packet_lab_table: (buffer, offset) => {
      let { value: action_type, size: action_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"0":"combine","1":"react"}[value] || value, size }
      })(buffer, offset)
      let { value: position, size: positionSize } = (ctx.vec3u)(buffer, offset + action_typeSize)
    ...
    packet_update_block_synced: (buffer, offset) => {
      ...
      let { value: transition_type, size: transition_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.varint64)(buffer, offset)
    ...
    packet_spawn_particle_effect: (buffer, offset) => {
      ...
      return { value: { dimension, entity_id, position, particle_name }, size: dimensionSize + entity_idSize + positionSize + particle_nameSize}
    },
    ...
    packet_structure_template_data_export_request: (buffer, offset) => {
      ...
      let { value: request_type, size: request_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"1":"export_from_save","2":"export_from_load","3":"query_saved_structure"}[value] || value, size }
    ...
    packet_structure_template_data_export_response: (buffer, offset) => {
      ...
      let { value: response_type, size: response_typeSize } = ((buffer, offset) => {
        const { value, size } = (ctx.u8)(buffer, offset)
        return { value: {"1":"export","2":"query"}[value] || value, size }
    ...
    packet_player_auth_input: (buffer, offset) => {
      ...
      })(buffer, offset + pitchSize + yawSize + positionSize + move_vectorSize + head_yawSize + input_dataSize + input_modeSize + play_modeSize + gaze_directionSize + tickSize + deltaSize)
      ...
      })(buffer, offset + pitchSize + yawSize + positionSize + move_vectorSize + head_yawSize + input_dataSize + input_modeSize + play_modeSize + gaze_directionSize + tickSize + deltaSize + transactionSize)
      ...
      })(buffer, offset + pitchSize + yawSize + positionSize + move_vectorSize + head_yawSize + input_dataSize + input_modeSize + play_modeSize + gaze_directionSize + tickSize + deltaSize + transactionSize + item_stack_requestSize)
      return { value: { pitch, yaw, position, move_vector, head_yaw, input_data, input_mode, play_mode, gaze_direction, tick, delta, transaction, item_stack_request, block_action }, size: pitchSize + yawSize + positionSize + move_vectorSize + head_yawSize + input_dataSize + input_modeSize + play_modeSize + gaze_directionSize + tickSize + deltaSize + transactionSize + item_stack_requestSize + block_actionSize}
    },
