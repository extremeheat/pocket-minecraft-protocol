  ...
  const ctx = {
    ...
    ItemExtraDataWithBlockingTick: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        offset = (ctx.li32)(value.length, buffer, offset)
        for (let i = 0; i < value.length; i++) {
          offset = (ctx.ShortArray)(value[i], buffer, offset)
        }
        return offset
    ...
    ItemStackRequest: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        ...
        for (let i = 0; i < value.length; i++) {
          ...
          offset = ((value, buffer, offset) => {
            return (ctx.u8)({"take":0,"place":1,"swap":2,"drop":3,"destroy":4,"consume":5,"create":6,"lab_table_combine":7,"beacon_payment":8,"mine_block":9,"craft_recipe":10,"craft_recipe_auto":11,"craft_creative":12,"optional":13,"non_implemented":14,"results_deprecated":15}[value] || value, buffer, offset)
    ...
    ItemStackResponses: (value, buffer, offset) => {
      ...
      for (let i = 0; i < value.length; i++) {
        ...
        offset = (ctx.varint32)(request_id1, buffer, offset)
    ...
    CommandOrigin: (value, buffer, offset) => {
      let type = value.type
      offset = ((value, buffer, offset) => {
        return (ctx.varint)({"player":0,"block":1,"minecart_block":2,"dev_console":3,"test":4,"automation_player":5,"client_automation":6,"dedicated_server":7,"entity":8,"virtual":9,"game_argument":10,"entity_server":11,"precompiled":12,"game_director_entity_server":13,"script":14}[value] || value, buffer, offset)
      })(type, buffer, offset)
      let uuid = value.uuid
      offset = (ctx.uuid)(uuid, buffer, offset)
      let request_id = value.request_id
    ...
    StructureBlockSettings: (value, buffer, offset) => {
      ...
      offset = (ctx.u8)(mirror, buffer, offset)
    ...
    WindowType: (value, buffer, offset) => {
      return (ctx.i8)({"container":0,"workbench":1,"furnace":2,"enchantment":3,"brewing_stand":4,"anvil":5,"dispenser":6,"dropper":7,"hopper":8,"cauldron":9,"minecart_chest":10,"minecart_hopper":11,"horse":12,"beacon":13,"structure_editor":14,"trading":15,"command_block":16,"jukebox":17,"armor":18,"hand":19,"compound_creator":20,"element_constructor":21,"material_reducer":22,"lab_table":23,"loom":24,"lectern":25,"grindstone":26,"blast_furnace":27,"smoker":28,"stonecutter":29,"cartography":30,"hud":31,"jigsaw_editor":32,"smithing_table":33,"none":-9,"inventory":-1}[value] || value, buffer, offset)
    },
    ContainerSlotType: (value, buffer, offset) => {
      return (ctx.u8)({"anvil_input":0,"anvil_material":1,"anvil_result":2,"smithing_table_input":3,"smithing_table_material":4,"smithing_table_result":5,"armor":6,"container":7,"beacon_payment":8,"brewing_input":9,"brewing_result":10,"brewing_fuel":11,"hotbar_and_inventory":12,"crafting_input":13,"crafting_output":14,"recipe_construction":15,"recipe_nature":16,"recipe_items":17,"recipe_search":18,"recipe_search_bar":19,"recipe_equipment":20,"enchanting_input":21,"enchanting_lapis":22,"furnace_fuel":23,"furnace_ingredient":24,"furnace_output":25,"horse_equip":26,"hotbar":27,"inventory":28,"shulker":29,"trade_ingredient1":30,"trade_ingredient2":31,"trade_result":32,"offhand":33,"compcreate_input":34,"compcreate_output":35,"elemconstruct_output":36,"matreduce_input":37,"matreduce_output":38,"labtable_input":39,"loom_input":40,"loom_dye":41,"loom_material":42,"loom_result":43,"blast_furnace_ingredient":44,"smoker_ingredient":45,"trade2_ingredient1":46,"trade2_ingredient2":47,"trade2_result":48,"grindstone_input":49,"grindstone_additional":50,"grindstone_result":51,"stonecutter_input":52,"stonecutter_result":53,"cartography_input":54,"cartography_additional":55,"cartography_result":56,"barrel":57,"cursor":58,"creative_output":59}[value] || value, buffer, offset)
    },
    SoundType: (value, buffer, offset) => {
      return (ctx.varint)({"ItemUseOn":0,"Hit":1,"Step":2,"Fly":3,"Jump":4,"Break":5,"Place":6,"HeavyStep":7,"Gallop":8,"Fall":9,"Ambient":10,"AmbientBaby":11,"AmbientInWater":12,"Breathe":13,"Death":14,"DeathInWater":15,"DeathToZombie":16,"Hurt":17,"HurtInWater":18,"Mad":19,"Boost":20,"Bow":21,"SquishBig":22,"SquishSmall":23,"FallBig":24,"FallSmall":25,"Splash":26,"Fizz":27,"Flap":28,"Swim":29,"Drink":30,"Eat":31,"Takeoff":32,"Shake":33,"Plop":34,"Land":35,"Saddle":36,"Armor":37,"MobArmorStandPlace":38,"AddChest":39,"Throw":40,"Attack":41,"AttackNoDamage":42,"AttackStrong":43,"Warn":44,"Shear":45,"Milk":46,"Thunder":47,"Explode":48,"Fire":49,"Ignite":50,"Fuse":51,"Stare":52,"Spawn":53,"Shoot":54,"BreakBlock":55,"Launch":56,"Blast":57,"LargeBlast":58,"Twinkle":59,"Remedy":60,"Infect":61,"LevelUp":62,"BowHit":63,"BulletHit":64,"ExtinguishFire":65,"ItemFizz":66,"ChestOpen":67,"ChestClosed":68,"ShulkerBoxOpen":69,"ShulkerBoxClosed":70,"EnderChestOpen":71,"EnderChestClosed":72,"PowerOn":73,"PowerOff":74,"Attach":75,"Detach":76,"Deny":77,"Tripod":78,"Pop":79,"DropSlot":80,"Note":81,"Thorns":82,"PistonIn":83,"PistonOut":84,"Portal":85,"Water":86,"LavaPop":87,"Lava":88,"Burp":89,"BucketFillWater":90,"BucketFillLava":91,"BucketEmptyWater":92,"BucketEmptyLava":93,"ArmorEquipChain":94,"ArmorEquipDiamond":95,"ArmorEquipGeneric":96,"ArmorEquipGold":97,"ArmorEquipIron":98,"ArmorEquipLeather":99,"ArmorEquipElytra":100,"Record13":101,"RecordCat":102,"RecordBlocks":103,"RecordChirp":104,"RecordFar":105,"RecordMall":106,"RecordMellohi":107,"RecordStal":108,"RecordStrad":109,"RecordWard":110,"Record11":111,"RecordWait":112,"unknown1":113,"Flop":114,"ElderGuardianCurse":115,"MobWarning":116,"MobWarningBaby":117,"Teleport":118,"ShulkerOpen":119,"ShulkerClose":120,"Haggle":121,"HaggleYes":122,"HaggleNo":123,"HaggleIdle":124,"ChorusGrow":125,"ChorusDeath":126,"Glass":127,"PotionBrewed":128,"CastSpell":129,"PrepareAttack":130,"PrepareSummon":131,"PrepareWololo":132,"Fang":133,"Charge":134,"CameraTakePicture":135,"LeashKnotPlace":136,"LeashKnotBreak":137,"Growl":138,"Whine":139,"Pant":140,"Purr":141,"Purreow":142,"DeathMinVolume":143,"DeathMidVolume":144,"unknown2":145,"ImitateCaveSpider":146,"ImitateCreeper":147,"ImitateElderGuardian":148,"ImitateEnderDragon":149,"ImitateEnderman":150,"unknown3":151,"ImitateEvocationIllager":152,"ImitateGhast":153,"ImitateHusk":154,"ImitateIllusionIllager":155,"ImitateMagmaCube":156,"ImitatePolarBear":157,"ImitateShulker":158,"ImitateSilverfish":159,"ImitateSkeleton":160,"ImitateSlime":161,"ImitateSpider":162,"ImitateStray":163,"ImitateVex":164,"ImitateVindicationIllager":165,"ImitateWitch":166,"ImitateWither":167,"ImitateWitherSkeleton":168,"ImitateWolf":169,"ImitateZombie":170,"ImitateZombiePigman":171,"ImitateZombieVillager":172,"BlockEndPortalFrameFill":173,"BlockEndPortalSpawn":174,"RandomAnvilUse":175,"BottleDragonBreath":176,"PortalTravel":177,"ItemTridentHit":178,"ItemTridentReturn":179,"ItemTridentRiptide1":180,"ItemTridentRiptide2":181,"ItemTridentRiptide3":182,"ItemTridentThrow":183,"ItemTridentThunder":184,"ItemTridentHitGround":185,"Default":186,"BlockFletchingTableUse":187,"ElemConstructOpen":188,"IceBombHit":189,"BalloonPop":190,"LtReactionIceBomb":191,"LtReactionBleach":192,"LtReactionEPaste":193,"LtReactionEPaste2":194,"LtReactionFertilizer":195,"LtReactionFireball":196,"LtReactionMgsalt":197,"LtReactionMiscfire":198,"LtReactionFire":199,"LtReactionMiscexplosion":200,"LtReactionMiscmystical":201,"LtReactionMiscmystical2":202,"LtReactionProduct":203,"SparklerUse":204,"GlowstickUse":205,"SparklerActive":206,"ConvertToDrowned":207,"BucketFillFish":208,"BucketEmptyFish":209,"BubbleUp":210,"BubbleDown":211,"BubblePop":212,"BubbleUpInside":213,"BubbleDownInside":214,"HurtBaby":215,"DeathBaby":216,"StepBaby":217,"BabySpawn":218,"Born":219,"BlockTurtleEggBreak":220,"BlockTurtleEggCrack":221,"BlockTurtleEggHatch":222,"TurtleLayEgg":223,"BlockTurtleEggAttack":224,"BeaconActivate":225,"BeaconAmbient":226,"BeaconDeactivate":227,"BeaconPower":228,"ConduitActivate":229,"ConduitAmbient":230,"ConduitAttack":231,"ConduitDeactivate":232,"ConduitShort":233,"Swoop":234,"BlockBambooSaplingPlace":235,"PreSneeze":236,"Sneeze":237,"AmbientTame":238,"Scared":239,"BlockScaffoldingClimb":240,"CrossbowLoadingStart":241,"CrossbowLoadingMiddle":242,"CrossbowLoadingEnd":243,"CrossbowShoot":244,"CrossbowQuickChargeStart":245,"CrossbowQuickChargeMiddle":246,"CrossbowQuickChargeEnd":247,"AmbientAggressive":248,"AmbientWorried":249,"CantBreed":250,"ItemShieldBlock":251,"ItemBookPut":252,"BlockGrindstoneUse":253,"BlockBellHit":254,"BlockCampfireCrackle":255,"Roar":256,"Stun":257,"BlockSweetBerryBushHurt":258,"BlockSweetBerryBushPick":259,"UICartographyTableTakeResult":260,"UIStoneCutterTakeResult":261,"BlockComposterEmpty":262,"BlockComposterFill":263,"BlockComposterFillSuccess":264,"BlockComposterReady":265,"BlockBarrelOpen":266,"BlockBarrelClose":267,"RaidHorn":268,"BlockLoomUse":269,"AmbientRaid":270,"UICartographyTableUse":271,"UIStoneCutterUse":272,"UILoomUse":273,"SmokerUse":274,"BlastFurnaceUse":275,"SmithingTableUse":276,"Screech":277,"Sleep":278,"FurnaceUse":279,"MooshroomConvert":280,"MilkSuspiciously":281,"Celebrate":282,"JumpPrevent":283,"AmbientPollinate":284,"BeeHiveDrip":285,"BeeHiveEnter":286,"BeeHiveExit":287,"BeeHiveWork":288,"BeeHiveShear":289,"HoneyBottleDrink":290,"AmbientCave":291,"Retreat":292,"ConvertToZombified":293,"Admire":294,"StepLava":295,"Tempt":296,"Panic":297,"Angry":298,"AmbientWarpedForest":299,"AmbientSoulsandValley":300,"AmbientNetherWastes":301,"AmbientBasaltDeltas":302,"AmbientCrimsonForest":303,"RespawnAnchorCharge":304,"RespawnAnchorDeplete":305,"RespawnAnchorSetSpawn":306,"RespawnAnchorAmbient":307,"SoulEscapeQuiet":308,"SoulEscapeLoud":309,"RecordPigstep":310,"LinkCompassToLodestone":311,"BlockSmithingTableUse":312,"EquipNetherite":313,"AmbientLoopWarpedForest":314,"AmbientLoopSoulsandValley":315,"AmbientLoopNetherWastes":316,"AmbientLoopBasaltDeltas":317,"AmbientLoopCrimsonForest":318,"AmbientAdditionWarpedForest":319,"AmbientAdditionSoulsandValley":320,"AmbientAdditionNetherWastes":321,"AmbientAdditionBasaltDeltas":322,"AmbientAdditionCrimsonForest":323,"SculkSensorPowerOn":324,"SculkSensorPowerOff":325,"BucketFillPowderSnow":326,"BucketEmptyPowderSnow":327,"PointedDripstoneCauldronDripWater":328,"PointedDripstoneCauldronDripLava":329,"PointedDripstoneDripWater":330,"PointedDripstoneDripLava":331,"CaveVinesPickBerries":332,"BigDripleafTiltDown":333,"BigDripleafTiltUp":334,"Undefined":335}[value] || value, buffer, offset)
    },
    ...
    packet_animate: (value, buffer, offset) => {
      let action_id = value.action_id
      offset = ((value, buffer, offset) => {
        return (ctx.zigzag32)({"none":0,"swing_arm":1,"unknown":2,"wake_up":3,"critical_hit":4,"magic_critical_hit":5,"row_right":6,"row_left":7}[value] || value, buffer, offset)
      })(action_id, buffer, offset)
      let runtime_entity_id = value.runtime_entity_id
      offset = (ctx.varint64)(runtime_entity_id, buffer, offset)
      return offset
          ...
          offset = ((value, buffer, offset) => {
            ...
            for (let i = 0; i < value.length; i++) {
              ...
              for (let i = 0; i < value.length; i++) {
                ...
                offset = ((value, buffer, offset) => {
                  return (ctx.lu16)({"int":1,"float":2,"value":3,"wildcard_int":4,"operator":5,"target":6,"file_path":16,"string":32,"position":40,"message":44,"raw_text":46,"json":50,"command":63}[value] || value, buffer, offset)
    ...
    packet_command_block_update: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        switch (is_block) {
          ...
          default: return ((value, buffer, offset) => {
            ...
            offset = (ctx.varint64)(minecart_entity_runtime_id, buffer, offset)
            return offset
          })(value, buffer, offset)
        }
      })(position, buffer, offset)
      ...
      offset = ((value, buffer, offset) => {
        switch (is_block) {
          default: return (ctx.varint64)(value, buffer, offset)
        }
    ...
    packet_npc_request: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        return (ctx.u8)({"set_actions":0,"execute_action":1,"execute_closing_commands":2,"set_name":3,"set_skin":4,"set_interaction_text":5}[value] || value, buffer, offset)
      })(request_type, buffer, offset)
      let command = value.command
      offset = (ctx.string)(command, buffer, offset)
      let action_type = value.action_type
      offset = (ctx.u8)(action_type, buffer, offset)
      return offset
    },
    ...
    packet_lab_table: (value, buffer, offset) => {
      let action_type = value.action_type
      offset = ((value, buffer, offset) => {
        return (ctx.u8)({"combine":0,"react":1}[value] || value, buffer, offset)
      })(action_type, buffer, offset)
      let position = value.position
      offset = (ctx.vec3u)(position, buffer, offset)
    ...
    packet_update_block_synced: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        return (ctx.varint64)({"entity":0,"create":1,"destroy":2}[value] || value, buffer, offset)
    ...
    packet_structure_template_data_export_request: (value, buffer, offset) => {
      ...
      let request_type = value.request_type
      offset = ((value, buffer, offset) => {
        return (ctx.u8)({"export_from_save":1,"export_from_load":2,"query_saved_structure":3}[value] || value, buffer, offset)
      })(request_type, buffer, offset)
      return offset
    },
    packet_structure_template_data_export_response: (value, buffer, offset) => {
      ...
      offset = ((value, buffer, offset) => {
        return (ctx.u8)({"export":1,"query":2}[value] || value, buffer, offset)
