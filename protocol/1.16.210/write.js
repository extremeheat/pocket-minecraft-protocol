module.exports = native => {
  const ctx = {
    ...
    ItemStack: (value, buffer, offset) => {
      ...
      offset = (ctx.varint)(stack_id, buffer, offset)
      let item = value.item
